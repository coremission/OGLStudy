...
GLuint Core::ShaderLoader::CreateShader(GLenum shaderType, std::string source, char * shaderName)
{
	int compileResult = 0;
...
GLuint Core::ShaderLoader::CreateProgram(char * vertexShaderFilename, char * fragmentShaderFilename)
{
